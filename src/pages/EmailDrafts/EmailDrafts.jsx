...
const EmailDrafts = () => {
  ...
  const handleOpenDraft = (draft) => {
    ...
    // Ensure detail view is visible (block) before animating opacity/transform
    ...
    tl.to(listViewRef.current, {
      ...
      onComplete: () => {
        ...
        // Set state after animation start to render data, but we already have draft passed in
      }
    });
            ...
            <div className={styles.detailContent}>
                <Card className={styles.emailEditorCard} radius="12px">
                    <div className={styles.formGroup}>
                        ...
                        <InputField
                            ...
                            onChange={() => {}} // Read-only for now, or state managed if editable
                ...
                <div className={styles.sidebar}>
                    ...
                    <Card className={styles.sidebarCard} radius="12px">
                        ...
                        <ul className={styles.riskList} style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                            {selectedDraft.risks.map((risk, index) => (
                                <li key={index} style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px', fontSize: '14px', color: '#212529' }}>
                                    <span style={{ width: '8px', height: '8px', backgroundColor: '#EE202E', borderRadius: '50%', flexShrink: 0 }}></span>
                                    {risk}
                                </li>
                            ))}
                        </ul>
